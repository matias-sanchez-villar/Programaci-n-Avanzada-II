...
import com.example.donapp.databinding.ActivityInstitucionBinding;
...
public class InstitucionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityInstitucionBinding.inflate(getLayoutInflater());
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.institucion, menu);
        return true;
    }
